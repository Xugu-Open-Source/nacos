...
public class PropertyUtil implements ApplicationContextInitializer<ConfigurableApplicationContext> {
    ...
    private void loadSetting() {
        try {
            ...
            setUseExternalDB(Arrays.asList(PropertiesConstant.MYSQL, PropertiesConstant.XUGU)
                    .contains(getString(PropertiesConstant.SPRING_DATASOURCE_PLATFORM, "").toLowerCase()));
